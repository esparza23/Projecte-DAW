...
class UploadHandler
{
    ...
    protected $error_messages = array(
        ...
        'no_space' => 'No hay espacio suficiente en tu cuenta'
    );
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
        $this->options = array(
            ...
            'upload_dir' => '../../Usuarios/'.$_SESSION['nom'].'/'.$_SESSION['carpetaActual'].'/',
            'upload_url' => '../../Usuarios/'.$_SESSION['nom'].'/'.$_SESSION['carpetaActual'].'/',
            'user_dirs' => false,
            'mkdir_mode' => 0755,
            'param_name' => 'files',
            ...
            'image_versions' => array(
                ...
                */
                'thumbnail' => array(
                    ...
                    'upload_dir' => '../../Usuarios/tmp/'.$_SESSION['nom'].'/thumbnail/',
                    'upload_url' => '../../Usuarios/tmp/'.$_SESSION['nom'].'/thumbnail/',
    ...
    protected function validate($uploaded_file, $file, $error, $index) {
        ...
        if ($result = $db->query($query))
        {
            ...
            if(($row[3]-$row[4]) >= $file->size)
            {
                return true;
            }
            else 
            {
                $file->error = $this->get_error_message('no_space');
                return false;
            }
        }
    }
